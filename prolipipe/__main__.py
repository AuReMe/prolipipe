...
usage: prolipipe [-h] [-pad PADMETS] [-i REACTIONS] -o OUTDIR -t TAXFILE -p PWY_FOLD [-nr] [-v]

Prolipipe pipeline for large-scale assessment of metabolic profiles on bacteria focusing on specific pathways.

options:
  -h, --help            show this help message and exit
  -pad, --padmet-dir PADMETS
                        Path to the merged padmet directory generated by AuFAMe (either -i or -pad).
  -i, --input-tsv REACTIONS
                        Path to the reactions.tsv file generated by AuFAMe (either -i or -pad).
  -o, --outdir OUTDIR   Path to the outdir folder.
  -t, --tax TAXFILE     path of the taxon file (.tsv)
  -p, --pwy PWY_FOLD    Path to the folder with the pathways.txt files for all wanted metabolites.
  -nr, --no-report      Use if you don't want interactive Quarto report.
...
def parser() : 
    ...
    ## arguments 
    parser.add_argument("-pad", "--padmet-dir", dest="padmets", default=argparse.SUPPRESS, help="Path to the merged padmet directory generated by AuFAMe (either -i or -pad).")
    parser.add_argument("-i", "--input-tsv", dest="reactions", default=argparse.SUPPRESS, help="Path to the reactions.tsv file generated by AuFAMe (either -i or -pad).")
