...
options:
  ...
  -i, --input-tsv REACTIONS
                        Path to the reactions.tsv file generated by AuFAMe (not used if --padmet-dir is provided).
...
def parser() : 
    ...
    parser.add_argument("-i", "--input-tsv", dest="reactions", default=argparse.SUPPRESS, help="Path to the reactions.tsv file generated by AuFAMe (not used if --padmet-dir is provided).")
